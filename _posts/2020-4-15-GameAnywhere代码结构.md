...
[GameAnywhere](https://github.com/chunying/gaminganywhere) 是一个开源的云游戏平台，由 **Chun-Ying Huang** 在2013年开发，最开始是毕业论文研究使用，近期随着云游戏风口正盛，这个项目关注度又有起色，本文介绍GameAnywhere代码构成。GameAnywhere 的License为 [BSD3](https://github.com/chunying/gaminganywhere/blob/master/LICENSE)，可以修改代码后闭源，但是项目依赖的开源组件较多，需要注意 License。<!--more-->
